...
/**
 * This record serves the purpose of mapping fields the FE should send to the BE,
 * to search a test activity.
 */
@Schema(description = "Search parameters for testing activity search API")
public record ActivitySearchRequestDto(
    @Schema(description = "Seedlot and/or Family Lot numbers",
        example = "[\"12345\", \"F20082140146\"]")
    ...
    @Schema(description = "Request ID, used to filter req_id (first 11 char) "
        + "and item_id (the 12th char)")
    @Size(max = 12)
    String requestId,
