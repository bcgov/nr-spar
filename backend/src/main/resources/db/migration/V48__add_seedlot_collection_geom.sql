...
alter table spar.seedlot add column collection_geom geometry(MULTIPOLYGON, 4326);

comment on column spar.seedlot.collection_geom is 'The user-drawn multi-polygon representing the Seedlot collection area of interest (AOI), stored in WGS-84 (SRID 4326).';

/* Update Seedlot Audit table */
alter table spar.seedlot_audit add column collection_geom geometry(MULTIPOLYGON, 4326);

comment on column spar.seedlot_audit.collection_geom is 'Referring value for spar.seedlot.collection_geom column';
...
BEGIN
    ...
    /*collection_geom                */ NEW.collection_geom
    );
        RETURN NEW;
    ...
    /*collection_geom                */ OLD.collection_geom
    );
        RETURN OLD;
