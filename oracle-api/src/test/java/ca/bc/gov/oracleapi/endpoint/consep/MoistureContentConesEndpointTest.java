...
class MoistureContentConesEndpointTest {
    ...
    void validateMoistureContentData_BadRequest() throws Exception {
        ...
        when(moistureContentService.getMoistureConeContentData(riaKey)).thenThrow(new ResponseStatusException(org.springframework.http.HttpStatus.BAD_REQUEST, "Invalid request"));
    ...
    void acceptMoistureContentData_BadRequest() throws Exception {
        ...
        doThrow(new ResponseStatusException(org.springframework.http.HttpStatus.BAD_REQUEST, "Invalid request"))
