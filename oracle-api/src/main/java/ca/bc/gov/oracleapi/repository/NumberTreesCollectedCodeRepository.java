...
public interface NumberTreesCollectedCodeRepository
    extends JpaRepository<NumberTreesCollectedCodeEntity, String> {

  @Query(
      """
      SELECT new ca.bc.gov.oracleapi.dto.CodeDescriptionDto(
        n.code, n.description, n.effectiveDate, n.expiryDate)
      FROM NumberTreesCollectedCodeEntity n
      WHERE CURRENT_DATE >= n.effectiveDate AND CURRENT_DATE < n.expiryDate
      ORDER BY n.code
      """)
