const ROUTES = {
  ...
  SEEDLOT_B_CLASS_REGISTRATION: '/seedlots/b-class-registration/:seedlotNumber',
  SEEDLOT_MAP: '/seedlots/map/:seedlotNumber',
  ...
  SEEDLOT_B_CLASS_REVIEW: '/seedlots/b-class/review/:seedlotNumber',
