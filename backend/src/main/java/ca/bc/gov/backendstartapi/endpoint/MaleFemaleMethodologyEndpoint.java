...
public class MaleFemaleMethodologyEndpoint {
  ...
  @Operation(summary = "Retrieves all male and female gametic methodologies",
  ...
  @ApiResponses(value = {
      @ApiResponse(responseCode = "200",
          ...
          content = @Content(array = @ArraySchema(schema = @Schema(type = "object")),
              ...
              schemaProperties = {@SchemaProperty(name = "code",
                  schema = @Schema(type = "string",
                      description = "This string represents a methodology code", example = "M1")),
                  @SchemaProperty(name = "description",
                      schema = @Schema(type = "string",
                          description = "Describe the name of the methodology",
                          example = "Portion of Ramets in Orchard")),
                  @SchemaProperty(name = "isPLI",
                      schema = @Schema(type = "boolean",
                          description = "Indicate whether this methodology is applicable to the logepole pine species",
                          example = "false"))})),
