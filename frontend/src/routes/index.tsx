...
const BrowserRoutes: Array<RouteObject> = [
  ...
  {
    path: ROUTES.ROOT,
    element: <Navigate to={getStoredPath()} replace />,
  },
  ...
  },
  {
    ...
    element: <SeedlotReview />,
  },
  {
    path: ROUTES.TSC_SEEDLOTS_TABLE,
    element: <ReviewSeedlots />,
  },
  {
  ...
  },
  {
    ...
    element: <MoistureContent />,
  },
  {
    path: ROUTES.MANUAL_PURITY_CONTENT,
    element: <PurityContent />,
  },
];
