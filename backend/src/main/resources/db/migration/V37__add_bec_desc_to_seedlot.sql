-- Add a BEC zone description column to the seedlot table --
ALTER TABLE
  spar.seedlot
ADD
  COLUMN bgc_zone_description varchar(120) default null;

COMMENT ON COLUMN spar.seedlot.bgc_zone_description IS 'The description of the BEC zone.';
