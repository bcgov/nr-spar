-- Fixing Seedlot Audit table - Adding bgc_zone_description column

alter table spar.seedlot_audit
  add column bgc_zone_description varchar(120) default null;

/*  
-- Function to fix Insert/Update/Delete statements executed on seedlot the table.
