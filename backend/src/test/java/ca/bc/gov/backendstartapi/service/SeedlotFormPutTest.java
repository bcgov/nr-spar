...
class SeedlotFormPutTest {
  ...
  void submitSeedlotForm_happyPath_shouldSucceed() {
    ...
    // BEC values
    assertEquals(oracleOrchardRet.getBecZoneCode(), seedlot.getBgcZoneCode());
    assertEquals(oracleOrchardRet.getBecZoneDescription(), seedlot.getBgcZoneDescription());
    assertEquals(oracleOrchardRet.getBecSubzoneCode(), seedlot.getBgcSubzoneCode());
    assertEquals(oracleOrchardRet.getVariant(), seedlot.getVariant());
    assertEquals(oracleOrchardRet.getBecVersionId(), seedlot.getBecVersionId());
