...
public class TestCodeService {
  ...
  /**
   * Get all valid activity type codes (where effective date <= today and expiry date >= today or null).
   *
  ...
  /**
   * Get all valid test category codes (where effective date <= today and expiry date >= today or null).
   *
   * @return list of TestCodeDto
   */
