...
const SeedlotRegistrationModel: ModelDefinition<OldSeedlotRegistrationObj> = Model.extend({});
const SeedlotInfoModel: ModelDefinition<OldSeedlotRegistrationObj> = Model.extend({});
