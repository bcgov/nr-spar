...
public interface ParentTreeRepository extends JpaRepository<ParentTreeEntity, Long> {
  ...
  @Query(
      value =
          """
            SELECT DISTINCT PT.PARENT_TREE_ID AS \"parentTreeId\", PT.PARENT_TREE_NUMBER AS \"parentTreeNumber\",
          ...
          """,
      nativeQuery = true)
  List<ParentTreeIdNumberProj> findAllParentTreeWithVegCode(String vegCode);
}
