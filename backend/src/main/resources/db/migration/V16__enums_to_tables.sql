...
comment on column spar.cone_collection_method.cone_collection_method_code is 'A code describing various Cone Collection Methods.';
...
insert into spar.cone_collection_method (cone_collection_method_code, description, effective_date, expiry_date, update_timestamp) values
...
alter table spar.seedlot_collection_method add constraint seedlot_cone_col_met_code_fk
		foreign key(cone_collection_method_code) references spar.cone_collection_method(cone_collection_method_code);
...
comment on column spar.genetic_class.genetic_class_code is 'A code describing various Genetic Classes.';
...
insert into spar.genetic_class (genetic_class_code, description, effective_date, expiry_date, update_timestamp) values
...
alter table spar.seedlot add constraint seedlot_genetic_class_code_fk
		foreign key(genetic_class_code) references spar.genetic_class(genetic_class_code);
...
comment on column spar.genetic_worth.genetic_worth_code is 'A code describing various Genetic Worths.';
...
insert into spar.genetic_worth (genetic_worth_code, description, effective_date, expiry_date, update_timestamp) values
...
comment on column spar.gametic_methodology.gametic_methodology_code is 'Code that describes the gametic contribution method code for a seedlot';
...
insert into spar.gametic_methodology (gametic_methodology_code, description, pli_species_ind, effective_date, expiry_date, update_timestamp) values
...
alter table spar.seedlot add constraint seedlot_female_game_mthd_cd_fk
		foreign key(female_gametic_mthd_code) references spar.gametic_methodology(gametic_methodology_code);
alter table spar.seedlot add constraint seedlot_male_game_mthd_cd_fk
		foreign key(male_gametic_mthd_code) references spar.gametic_methodology(gametic_methodology_code);
...
comment on column spar.method_of_payment.method_of_payment_code is 'A code describing various Method of Payments.';
...
insert into spar.method_of_payment (method_of_payment_code, description, effective_date, expiry_date, update_timestamp) values
...
alter table spar.seedlot_owner_quantity add constraint seedlot_own_qnt_meth_pay_cd_fk
		foreign key(method_of_payment_code) references spar.method_of_payment(method_of_payment_code);
...
comment on column spar.seedlot_source.seedlot_source_code is 'A code to indicate if an orchard seedlot is from tested parent trees, untested or custom.';
...
insert into spar.seedlot_source (seedlot_source_code, description, effective_date, expiry_date, update_timestamp) values
...
alter table spar.seedlot add constraint seedlot_seedlot_source_code_fk
		foreign key(seedlot_source_code) references spar.seedlot_source(seedlot_source_code);
...
comment on column spar.seedlot_status.seedlot_status_code is 'A code describing various Seedlot Statuses.';
...
insert into spar.seedlot_status (seedlot_status_code, description, effective_date, expiry_date, update_timestamp) values
...
alter table spar.seedlot add constraint seedlot_seedlot_status_code_fk
		foreign key(seedlot_status_code) references spar.seedlot_status(seedlot_status_code);
