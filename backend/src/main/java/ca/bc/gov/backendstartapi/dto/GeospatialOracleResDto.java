...
/**
 * This class represents a json response object when fetching geospatial data for a Parent Tree from
 * Oracle api.
 */
@Schema(
    description =
        "This class represents a json response object from Oracle when fetching geospatial data for"
            + " a Parent Tree.")
public record GeospatialOracleResDto(
    @Schema(description = "The id of a parent tree", example = "8512") Integer parentTreeId,
