 ...
 *
 * The returned zone codes are intended to travel alongside the polygon
 * in the `saveAoi` request payload so the backend can echo them in the
 * response DTO without recomputing server-side.
 *
