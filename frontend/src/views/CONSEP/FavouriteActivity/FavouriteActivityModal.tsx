...
// import { getFavAct, postFavAct, deleteFavAct } from
//  '../../../api-service/favouriteActivitiesAPI';
...
//                     />
//                     {row.cells?.map((cell) => {
//                       const Icon = Icons[headerIconMap[cell.value
// as keyof typeof headerIconMap]];
//                       return (
...
import { FavouriteActivityModalProps } from './definitions';

const FavouriteActivityModal = ({ open }: FavouriteActivityModalProps) => (
  <div>
    <h1>
      Modal
      {open }
