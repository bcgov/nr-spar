...
public record GameticMethodologyDto(
    ...
    @Schema(description = "The description of amethodlogy", example = "Visual Estimate")
        String description,
        @Schema(description = "The flag that indicates whether the methodology is applicable to female", example = "true")
        boolean isFemaleMethodology,
        @Schema(description = "The flag that indicates whether the methodology is applicable to lodgepole pine", example = "false")
